...
import 'package:linky/tracker.dart';
import 'package:new_loading_indicator/new_loading_indicator.dart';
import 'package:phone_form_field/phone_form_field.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:skeletonizer/skeletonizer.dart';
import 'package:linky/services/nominatimservice.dart';
import 'package:linky/services/photon_service.dart';
import 'package:linky/services/websocketserviceasync.dart';
  ...
  Future<void> match() async {
    ...
    if (response.statusCode == 200) {
      ...
      try {
        ...
        setState(() {
          this.driverid = receivedDriverId.toString(); // Update the class-level variable
        });
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 40),
              _kunaPending ? Center(
                child: Text("Cannot proceed while orders still pending", style: GoogleFonts.figtree(fontWeight: FontWeight.w800, color: Colors.deepOrangeAccent, fontSize: 15),),
              ):_buildSubmitButton(),
              //_buildSubmitButton(),
              SizedBox(height: 20),
            ],
